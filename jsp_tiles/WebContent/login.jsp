...
<form method="post" action="LServlet">
	...
	<div class="banner">
		...
		<center>
			...
			<h1>Please register your google accout!</h1>
		</center>
	</div> 
	<!--this is all part-->
	<div class="all">
		...
		<div class="right">
			...
			<div class ="right_content">
				<h2><strong>&nbspPlease register!</strong></h2>
				<table>
					<tr>
						<td>
							...
							<img width=100 height=50 alt="" src=<%if(image==null) {out.print("./image/google_logo.jpg");} else {out.print(image+".jpg");}%>>
